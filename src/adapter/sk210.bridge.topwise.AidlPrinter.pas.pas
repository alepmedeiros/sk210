...
unit sk210.bridge.topwise.AidlPrinter.pas;
...
begin
  TRegTypes.RegisterType('sk210.bridge.topwise.AidlPrinter.pas.JAidlPrinter', TypeInfo(sk210.bridge.topwise.AidlPrinter.pas.JAidlPrinter));
  TRegTypes.RegisterType('sk210.bridge.topwise.AidlPrinter.pas.JAidlPrinterListener', TypeInfo(sk210.bridge.topwise.AidlPrinter.pas.JAidlPrinterListener));
  TRegTypes.RegisterType('sk210.bridge.topwise.AidlPrinter.pas.JPrintCuttingMode', TypeInfo(sk210.bridge.topwise.AidlPrinter.pas.JPrintCuttingMode));
  TRegTypes.RegisterType('sk210.bridge.topwise.AidlPrinter.pas.JPrinterMessage', TypeInfo(sk210.bridge.topwise.AidlPrinter.pas.JPrinterMessage));
end;
