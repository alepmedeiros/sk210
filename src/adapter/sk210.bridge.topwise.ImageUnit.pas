...
unit sk210.bridge.topwise.ImageUnit;
...
// ===== Interface declarations =====
  ...
  JAlignClass = interface(JEnumClass)
    ['{959B34A5-A1CA-4C74-839A-77B4470CC726}']
  ...
  JAlign = interface(JEnum)
    ['{D2824287-2326-4CA6-B670-3B2CD85E942D}']
  ...
  JImageUnitClass = interface(JObjectClass)
    ['{932A01CA-F0AB-450F-B5EC-846E20AA6928}']
  ...
  JImageUnit = interface(JObject)
    ['{E21177CC-EC41-47E9-8EAF-2682BE129688}']
...
begin
  TRegTypes.RegisterType('sk210.bridge.topwise.ImageUnit.JAlign', TypeInfo(sk210.bridge.topwise.ImageUnit.JAlign));
  TRegTypes.RegisterType('sk210.bridge.topwise.ImageUnit.JImageUnit', TypeInfo(sk210.bridge.topwise.ImageUnit.JImageUnit));
end;
